			...
			<div class="container">
				<div class="alignR">
					...
					<c:if test="${empty LoginInfo}">
						<a href="<c:url value="/dang-ki" />"> <span class="icon-edit"></span>
							Đăng Ký
						</a>
					</c:if>
...
-->
	...
	<div class="copyright">
		<div class="container">
			<p class="pull-right">
				<a href="#"><img
					src="<c:url value="resources/assets/img/maestro.png"/>"
					alt="payment"></a> <a href="#"><img
					src="<c:url value="resources/assets/img/mc.png"/>" alt="payment"></a>
				<a href="#"><img
					src="<c:url value="resources/assets/img/pp.png"/>" alt="payment"></a>
				<a href="#"><img
					src="<c:url value="resources/assets/img/visa.png"/>" alt="payment"></a>
				<a href="#"><img
					src="<c:url value="resources/assets/img/disc.png"/>" alt="payment"></a>
			</p>
	...
	<script
		src="<c:url value="resources/assets/js/jquery.easing-1.3.min.js" />"></script>
	<script
		src="<c:url value="resources/assets/js/jquery.scrollTo-1.4.3.1-min.js" />"></script>
	<script src="<c:url value="resources/assets/js/shop.js" /> "></script>

	<decorator:getProperty property="page.editcart"></decorator:getProperty>
</body>
</html>
